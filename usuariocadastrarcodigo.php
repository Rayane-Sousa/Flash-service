...
$campoprofissao = $_POST["profissao"];
...
$sql = "INSERT INTO usuarios(nome, email, senha, acesso) VALUES('$camponome', '$campoemail', '$camposenha', '$campotelefone' '$campoprofissao' '$campoacesso')";
